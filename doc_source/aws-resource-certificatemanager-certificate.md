...
If the certificate request is not validated, the stack will eventually time out and be rolled back, deleting the pending certificate\. Resource timeouts are subject to change over time.
